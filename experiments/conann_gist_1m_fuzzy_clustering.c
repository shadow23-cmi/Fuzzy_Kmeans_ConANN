...
int main(void)
{
    ...
    float* calibration_vectors = read_fvecs("gist/gist_calibration.fvecs", &n_xc, &dim_xc);
    ...
    int* calibration_ground_truth_vectors = read_ivecs("gist/gist_calibration_groundtruth.ivecs", &n_gt_xc, &dim_gt_xc);
    //printf("check2\n");
